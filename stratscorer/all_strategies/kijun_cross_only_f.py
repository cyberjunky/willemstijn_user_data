# ==============================================================================================
# Kijun cross only strategy for Futures
#
# Made by:
...
# freqtrade backtesting -c user_data/futures_config.json -s kijun_cross_only_f --timerange=20190101-20210530 --timeframe=1d
# freqtrade backtesting-analysis
# freqtrade plot-dataframe -p BTC/USDT --strategy kijun_cross_only_f -c user_data/spot_config.json
#
...
class kijun_cross_only_f(IStrategy):
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # No kumo cloud, just buy long signal if close is above kijun...
        # Note: these two lines could easily be one, but for simplicity, I'm leaving it as is.
        dataframe["close_above_kijun"] = dataframe["close"] > dataframe["kijun"]
        # The buy long signal can only be True if the close_above_kijun is True
        dataframe["buy_long"] = (dataframe["close_above_kijun"] == True)

        # The sell short signals are similar to buy long, but reversed
        dataframe["close_below_kijun"] = dataframe["close"] < dataframe["kijun"]
        dataframe["sell_short"] = (dataframe["close_below_kijun"] == True)
