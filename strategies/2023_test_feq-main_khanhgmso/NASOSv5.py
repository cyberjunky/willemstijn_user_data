...
buy_params = {
    ...
    "ewo_high": 3.568,  # value loaded from strategy
    "ewo_high_2": -5.568,  # value loaded from strategy
    "ewo_low": -14.678,  # value loaded from strategy
    "lookback_candles": 32,  # value loaded from strategy
    "low_offset_2": 0.939,  # value loaded from strategy
    "profit_threshold": 1.035,  # value loaded from strategy
    "rsi_buy": 76,  # value loaded from strategy
    "rsi_fast_buy": 36,  # value loaded from strategy
}

# Sell hyperspace params:
sell_params = {
    "base_nb_candles_sell": 16,  # value loaded from strategy
    "high_offset": 1.079,  # value loaded from strategy
    "high_offset_2": 1.468,  # value loaded from strategy
}
